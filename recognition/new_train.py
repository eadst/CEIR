...
parser.add_argument('--l', type=int, default=500, help='Interval to be displayed')
...
for epoch in range(opt.niter):
    ...
    while i < len(train_loader):
        ...
        if i % opt.saveInterval == 0  or (opt.saveInterval >= len(train_loader) and i == len(train_loader)-1):
            torch.save(
                crnn.state_dict(), '/home/dong/Downloads/receipt/enctc.crnn/save/netCRNN_{0}_{1}.pth'.format(epoch, i))